...
<div class="content-card">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <a href="{{ route('admin.lessons.edit', $lesson) }}" class="btn btn-sm btn-primary me-2">
    ...
    <ul class="pagination shadow-sm rounded-pill">
        ...
        @else
            <li class="page-item"><a class="page-link rounded-pill" href="{{ $lessons->previousPageUrl() }}">&laquo;</a></li>
        @endif
        ...
        @if ($lessons->hasMorePages())
            <li class="page-item"><a class="page-link rounded-pill" href="{{ $lessons->nextPageUrl() }}">&raquo;</a></li>
        @else
