                ...
                <div>
                    ...
                    <div class="flex items-center text-sm text-gray-600">
                        <a href="{{ route('admin.exercises.index') }}"
                            class="text-primary hover:text-primary-light flex items-center">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center">
                                    ...
                                    <div
                                        class="px-4 py-1 bg-primary-light bg-opacity-10 rounded-full text-primary font-medium">
                                        {{ $exercise->type }}
                                    </div>
                                </div>
                ...
                @if ($exercise->questions->count() > 0)
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        @foreach ($exercise->questions as $question)
                            <div class="card transition-all duration-300 hover:shadow-lg hover:border-primary-light group"
                                ...
                                <div class="card-body flex flex-col h-full">
                                    ...
                                    <div class="flex-grow flex flex-col items-center text-center mb-4">
                                        <h3
                                            class="text-lg font-medium text-gray-900 mb-3 transition-colors group-hover:text-primary">
              ...
              box-shadow: 0 4px 10px rgba(255, 184, 77, 0.3);">
                                        ...
                                        <form action="{{ route('admin.exercises.destroy', $exercise) }}" method="POST">
                                            ...
                                            <button type="submit" class="btn btn-danger"
                                                onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet exercice? Toutes les questions associées seront également supprimées.')">
                                                <i class="fas fa-trash me-1"></i> Supprimer l'exercice
                                            </button>
                                        </form>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center py-8">
                                <div
                                    class="mx-auto w-16 h-16 rounded-full bg-primary bg-opacity-10 flex items-center justify-center mb-4">
